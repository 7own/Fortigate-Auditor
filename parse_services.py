...
p_entering_service_block = re.compile(r'^\s*config firewall service custom$', re.IGNORECASE)
...
# -- service number
p_service_number = re.compile(r'^\s*edit\s+(?P<service_number>\d+)', re.IGNORECASE)
