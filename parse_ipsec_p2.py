...
main_grp.add_option('-o', '--output-file', help='Output csv file (default ./ipsec-p2.csv)', default=path.abspath(path.join(os.getcwd(), './ipsec-p2.csv')))
...
p_entering_ipsec_block = re.compile(r'^\s*config vpn ipsec phase2-interface$', re.IGNORECASE)
